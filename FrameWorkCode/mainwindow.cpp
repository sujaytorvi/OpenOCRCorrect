...
void MainWindow::on_actionBold_toggled(bool isToggled)
{
    ...
    ui->textBrowser->textCursor().mergeCharFormat(format); // this will make text bold/normal to the selected text
    ui->textBrowser->mergeCurrentCharFormat(format); // this will apply format change (bold/normal) to new char entries

}


void MainWindow::on_actionItalic_toggled(bool isToggled)
{
    QTextCharFormat format;
        // this will apply format change (italic/normal) to new char entries
        if(isToggled)
        {
          ui->textBrowser->setFontItalic(isToggled);;
        }
        else{
            ui->textBrowser->setFontItalic(isToggled);
        ...
        ui->textBrowser->textCursor().mergeCharFormat(format); // this will make text italic/normal to the selected text
        ui->textBrowser->mergeCurrentCharFormat(format); // this will apply format change (italic /normal) to new char entries

}


void MainWindow::on_actionUnderline_toggled(bool isToggled)
{
    QTextCharFormat format;
    // if bold is active will make text underlined else normal
    if(isToggled)
    {
      ui->textBrowser->setFontUnderline(isToggled);;
    }
    else{
        ui->textBrowser->setFontUnderline(isToggled);
    ...
    ui->textBrowser->textCursor().mergeCharFormat(format); // this will make text underline/normal to the selected text
    ui->textBrowser->mergeCurrentCharFormat(format); // this will apply format change (underline/normal) to new char entries
}


void MainWindow::on_actionSuperScript_toggled(bool isToggled)
{
    QTextCharFormat format;
    if(isToggled){
...
void MainWindow::on_actionSubScript_toggled(bool isToggled)
{
    QTextCharFormat format;
    if(isToggled){
